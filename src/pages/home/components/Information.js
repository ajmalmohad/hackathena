    ...
    <div className='Information'>
      <div className='rules'>
        ...
        <div className='allpoints'>
          ...
          <RulesPoints className="spoint" color={"white"} textcol={"black"} Desc={"The registration begins on ****,2023 and ends on ****,2023"} />
          <RulesPoints className="spoint" color={"black"} Desc={"After registration, you have to submit your idea via devfolio before **** 2023"} />
