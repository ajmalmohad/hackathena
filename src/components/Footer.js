...
function Footer() {
  return (
    <div className='Footer'>
      ...
      <div className='links'>
        <a href='https://www.instagram.com/hackathena/'><img src={Insta} alt="Instagram" /></a>
        </div>
        <div className='others'>
              <a href="https://discord.gg/PWa22qKb6r">Discord</a>
              <a href="https://www.jecc.ac.in/">University</a>
        </div>
    </div>
  )
}
